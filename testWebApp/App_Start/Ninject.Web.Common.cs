...
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(testWebApp.App_Start.NinjectWebCommon), "Stop")]
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static IKernel CreateKernel()
        {
            ...
            try
            {
                ...
                kernel.Bind<IRoundRepository>().To<RoundRepository>();
